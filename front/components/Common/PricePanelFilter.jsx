...
const PricePanelFilter = ({ isSubFilterOn, subFilter }) => {
  ...
  const [minPrice, onChangeMinPrice, setMinPrice] = useNumberInput(
    initialPrices[0]
  );
  const [maxPrice, onChangeMaxPrice, setMaxPrice] = useNumberInput(
    initialPrices[1]
  );
