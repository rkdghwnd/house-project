...
const ProductShow = () => {
  const productSpecRef = useRef<HTMLBaseElement>(null);
  const productReviewRef = useRef<HTMLBaseElement>(null);
  const productInquiryRef = useRef<HTMLBaseElement>(null);
  const productShipmentRef = useRef<HTMLDivElement>(null);
  const productRecommendationRef = useRef<HTMLBaseElement>(null);
